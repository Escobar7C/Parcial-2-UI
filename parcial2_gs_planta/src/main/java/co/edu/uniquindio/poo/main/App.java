...
public class App {
    public static void main(String[] args) {
        ...
        Producto original = new Producto.Builder()
                .setNombre("Jugo verde com fresa")
                .addComponente("Limón")
                .addComponente("Espinaca")
                .addComponente("Fresa")
                .setPrecio(10)
                .build();

        Producto clon = original.clonar();

        Producto modificado = new Producto.Builder()
                .setNombre("Frutos rojos")
                .setPrecio(clon.getPrecio())
                .addComponente(clon.getComponentes().get(2))
                .addComponente("Mora")
                .addComponente("Frambueza")
                .build();
